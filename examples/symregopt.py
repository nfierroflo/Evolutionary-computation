...
class SymbolicRegression():
    def __init__(self, function="quarticpolynomial", has_test_set=False, invalid_fitness=9999999):
        ...
        trise=13.416
        tfall=40.076
        self.constants=[A,t0,gamma,beta,trise,tfall]
    ...
    def readpolynomial(self):
        ...
        if self.function in ["pagiepolynomial"]:
            ...
            #self.__train_set = l
            df = pd.read_csv('dataset/Total/TrainTotalv3A09.txt', sep=",",header=None)
    ...
    def get_error(self, individual, dataset):
        ...
        for fit_case in dataset:
            ...
            try:
                ...
                ctes=self.constants
                result = eval(individual, globals(), {"x": fit_case[:-1],"cte":ctes})
